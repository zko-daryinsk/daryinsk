...
window.app = {
    ...
    villages: [{id:"Дарьинское",ru:"Дарьинское",kz:"Дарьинское"}, {id:"Трёкино",ru:"Трёкино",kz:"Трёкино"}, {id:"Рубежка",ru:"Рубежка",kz:"Рубежка"}, {id:"Озёрное",ru:"Озёрное",kz:"Озёрное"}, {id:"Володарка",ru:"Володарка",kz:"Володарка"}],
    activeVillage: "darinsk"
};

const nameSynonyms = {
    // Мужские русские
    "саня": ["александр", "санек", "сашка"],
    "вова": ["владимир", "володя", "вовчик"],
    "паша": ["павел", "павлик"],
    "леша": ["алексей", "леха"],
    "дима": ["дмитрий", "димка"],
    "коля": ["николай", "колян"],
    "женя": ["евгений", "жека"],
    "серега": ["сергей", "сережа", "сергей"],
    "андрей": ["андрюха"],
    "юра": ["юрий"],
    "толик": ["анатолий"],
    "витя": ["виктор"],
    ...
    // Казахские мужские и женские синонимы
    "серик": ["серикбол", "серикбай", "али", "алихан"],
    "баха": ["бахтияр", "бахыт", "бахытжан"],
    "маха": ["махамбет", "махсуд"],
    "аза": ["азамат", "азат"],
    "арман": ["арманжан"],
    "алия": ["альфия", "алиюша"],
    "айка": ["айгерим", "айгуль", "айнур"],
    "аселя": ["асель", "асем"],
    "берик": ["беркут", "бека"],
    "ербол": ["ерболат", "ерик"],
    "канат": ["канатжан"],
...
function initApp() {
    restoreViewMode();
    window.app.activeVillage = "Дарьинское";
